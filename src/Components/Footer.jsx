    ...
    return (
        ...
        <div class="absolute mt-[480vh] lg:mt-[400vh] xl:mt-[500vh]  h-full  w-full bg-white oveflow-clip">
            ...
            <div class="flex flex-col space-y-8 ml-12 mt-10 xl:mt-12 2xl:mt-15">
                {/*Buttons*/}
                <button class="rounded-2xl bg-white w-36 xl:w-[32%] h-10  xl:h-18 text-center xl:flex items-center justify-between shadow-xl border-2  group hover:cursor-pointer transition-colors duration-300 z-80 hover:scale-105 ">
                    <p class=" text-sm   xl:text-3xl font-cabinet-grotesk text-stone-800 xl:ml-8 font-bold ">SCHEDULE A CALL</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"fill="currentColor"
                                        className="bi bi-arrow-right mr-4 font-bold text-home hidden xl:block group-hover:translate-x-5 duration-300  " viewBox="0 0 16 16">
                ...
                <button class="rounded-2xl bg-white w-36 h-10 xl:w-[32%] xl:h-18 text-center xl:flex items-center justify-between shadow-xl border-2 group hover:cursor-pointer transition-colors duration-300 z-80 hover:scale-105">
            ...
            <div class="flex space-x-12 ml-20 mt-10 lg:mt-5 xl:mt-5 2xl:mt-24">
                <div class="border-4 rounded-full border-white bg-white w-10 h-10 items-center justify-center flex duration-300 z-80 hover:scale-105 ">
